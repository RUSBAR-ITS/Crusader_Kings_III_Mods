...
$previous=Join-Path $PSScriptRoot '../ck3-agot-plus-fix-stage3-log-2026-09-18'
...
$targets=@(Import-Csv -LiteralPath (Join-Path $repo 'AGOT_Submods/AGOT_PLUS_FIX/docs/stage4-targeted-log-messages.csv'))
...
if($sameMods -and $oldDuplicate.Count -eq 1 -and $newDuplicate.Count -eq 1 -and
 $oldDuplicate[0].Message -match 'agot_activity_events_crown_commission\.txt' -and
 $newDuplicate[0].Message -match 'agot_coronation_crown_commission_events\.txt'){
