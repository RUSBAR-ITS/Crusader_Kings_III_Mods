param(
    ...
    [string]$RussianPath = 'E:\SteamLibrary\steamapps\workshop\content\1158310\3496379669'
)
...
$stats=[ordered]@{
    Method="Catalogs selected by language header; filename mismatches reported separately. Declared keys retained on missing closing quote."; EnglishKeys=$en.Count; TranslationKeys=$ru.Count; BuiltinRussianKeys=$builtin.Count
