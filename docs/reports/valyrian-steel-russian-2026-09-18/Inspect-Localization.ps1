param(
    [string]$MainPath = 'E:\SteamLibrary\steamapps\workshop\content\1158310\2962713441',
    [string]$RussianPath = 'E:\SteamLibrary\steamapps\workshop\content\1158310\3736917258'
)
